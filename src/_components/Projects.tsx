...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    {
      title: "Wild Oasis Customer App",
      image: "/wild-oasis-image.jpg",
      description:
        "A comprehensive full-featured hotel booking application designed from the customer's perspective. This modern web application allows guests to browse available rooms, make reservations, manage their bookings, and enjoy a seamless hotel booking experience with real-time availability updates.",
      technologies: ["React", "NextJS", "Supabase", "React Query"],
      liveUrl: "https://the-wild-oasis-website-ub.vercel.app/",
      githubUrl: "https://github.com/UjjwalBaranwal/the-wild-oasis-website.git",
      category: "Full Stack",
      featured: true,
    },
    {
    ...
    },
    {
      ...
      description:
        "A full-stack URL shortening service that transforms long URLs into custom short links. Includes comprehensive analytics tracking, visit statistics, click monitoring, user dashboard, and custom alias creation for better link management and sharing.",
      technologies: ["JavaScript", "NodeJS", "ReactJS", "MongoDB"],
      githubUrl: "https://github.com/UjjwalBaranwal/URL_Shortner.git",
      category: "Full Stack",
    },
    {
      ...
      technologies: ["React", "Netlify", "HTML5", "CSS3"],
    ...
    },
    {
      ...
      description:
        "An interactive quiz application with multiple categories, timed questions, score tracking, and progress saving. Built with modern React patterns including Redux for state management and RTK Query for efficient data fetching.",
      technologies: [
        "React JS",
        "Javascript",
        "Redux",
      ...
      githubUrl: "https://github.com/UjjwalBaranwal/React-Quiz-App.git",
      category: "Frontend",
    },
  ];
